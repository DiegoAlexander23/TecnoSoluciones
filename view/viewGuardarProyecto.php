...
<body>
  ...
  <div class="collapse navbar-collapse">
    ...
    <h1>Inserción de Proyectos</h1>
        ...
        <hr>
        <form action="index.php?accion=guardarproyecto" method="post"><br>
            Nombres: <br>
            <input type="text" name="txtNom" placeHolder="Nombre"class="form-control"><br>
            Apellidos: <br>
            <input type="text" name="txtDes" placeHolder="Apellido"class="form-control"><br>
            Fecha de Inicio: <br>
            <input type="date" class="form-control" name="txtFecha_inicio"><br>
            Fecha de Finalizacion: <br>
            <input type="date" class="form-control" name="txtFecha_fin"><br>
